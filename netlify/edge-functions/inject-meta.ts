...
export default async function handler(request: Request, context: any) {
  ...
  const seoBody = `<div class="seo-prerender" style="position:absolute;left:-9999px;top:-9999px;width:1px;height:1px;overflow:hidden;">
    ...
    <h2>Why Sri Lankan businesses choose Cypher Digital for ${safeTitle2}</h2>
    <p>Cypher Digital is a results-driven digital marketing agency based in Colombo, Sri Lanka, helping more than 200 brands grow online through performance marketing, creative content, search engine optimisation and paid advertising. Our work on ${safeH1.toLowerCase()} is built around clear KPIs, transparent reporting and proven frameworks that have generated over 15,000 qualified leads and an average return on ad spend of 5x for clients across Sri Lanka.</p>
    <p>We work with small and medium enterprises (SMEs), startups and established brands in Colombo, Kandy, Galle, Negombo, Jaffna, Kurunegala, Matara, Anuradhapura, Ratnapura and Batticaloa. Whether you are a hotel looking to increase direct bookings, a restaurant building a stronger local presence, a real estate developer generating buyer leads, a fashion brand growing on Instagram and TikTok, an education institute attracting more student enrolments, or a beauty salon filling the appointment book, our team designs digital marketing strategies tailored to your industry, budget and growth stage.</p>
    <h2>Our core digital marketing services in Sri Lanka</h2>
    <p>Cypher Digital offers a complete suite of digital marketing services under one roof so that Sri Lankan businesses can scale without juggling multiple agencies. Our services include search engine optimisation (SEO) for local and national keywords, Google Ads management covering Search, Display, YouTube and Shopping campaigns, Facebook and Instagram advertising with advanced audience targeting and creative testing, TikTok marketing and TikTok Ads, LinkedIn marketing and B2B lead generation, influencer marketing with vetted Sri Lankan creators, social media management and community engagement, content marketing, email marketing and marketing automation, conversion rate optimisation (CRO), landing page design, full website design and development, professional graphic design, brand identity and logo design, video production, motion graphics and animated ad creatives.</p>
    <p>Every campaign is supported by analytics, conversion tracking, attribution modelling and weekly or monthly performance reports so you always know exactly how your marketing budget is being spent and what return it is generating. We use tools like Google Analytics 4, Google Tag Manager, Google Search Console, Meta Business Suite, TikTok Ads Manager, LinkedIn Campaign Manager, Looker Studio, Semrush and Ahrefs to plan, measure and continuously improve your digital marketing performance in Sri Lanka.</p>
    <h2>How ${safeH1.toLowerCase()} drives growth for SMEs in Sri Lanka</h2>
    <p>Investing in ${safeH1.toLowerCase()} helps Sri Lankan businesses reach more of the right customers at the moment they are searching, scrolling or making buying decisions. Done well, it lowers customer acquisition cost, increases lifetime value, strengthens brand recall and creates a predictable pipeline of leads and sales. Cypher Digital combines local market knowledge, Sinhala, Tamil and English creative production, and proven international best practices to give your brand a real competitive advantage in the Sri Lankan market.</p>
    <p>We start every engagement with a discovery call, a detailed audit of your current digital presence, competitor benchmarking and a clear written strategy with timelines and KPIs. From there we execute, optimise and report — adjusting creatives, audiences, bids, landing pages and content based on real performance data instead of guesswork. This data-driven approach is why Cypher Digital is consistently rated one of the best digital marketing agencies in Sri Lanka.</p>
    <h2>Frequently asked questions about ${safeTitle2}</h2>
    <p><strong>How much does ${safeH1.toLowerCase()} cost in Sri Lanka?</strong> Pricing depends on scope, channels and goals. Most Cypher Digital packages start from LKR 25,000 to LKR 50,000 per month, with custom enterprise plans available for larger brands. We provide transparent quotes after a free discovery call so you know exactly what you are paying for.</p>
    <p><strong>How long until I see results?</strong> Paid advertising campaigns like Google Ads, Facebook Ads and TikTok Ads can start generating leads within the first week. SEO, content marketing and organic social typically show meaningful results within 3 to 6 months. We share early indicators and weekly progress so you always have visibility.</p>
    <p><strong>Do you work with businesses outside Colombo?</strong> Yes. We serve clients across all of Sri Lanka including Kandy, Galle, Negombo, Jaffna, Kurunegala, Matara, Anuradhapura, Trincomalee, Batticaloa and Nuwara Eliya, and also work with Sri Lankan-owned businesses internationally.</p>
    <p><strong>Why choose Cypher Digital over other digital marketing companies in Sri Lanka?</strong> Our work is judged on results, not vanity metrics. We combine senior strategists, creative producers, paid media specialists, SEO experts and developers under one roof, with transparent reporting and a clear focus on revenue, leads and ROI for Sri Lankan SMEs.</p>
    <p>Ready to grow? Contact Cypher Digital today on WhatsApp at +94 70 177 2626, email hello@cypherdigital.lk or visit cypherdigital.lk to book your free strategy session and get a custom proposal for ${safeH1.toLowerCase()} tailored to your business goals in Sri Lanka.</p>
  </div>`;
