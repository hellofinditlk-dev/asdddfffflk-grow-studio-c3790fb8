...
export const vacancies: Vacancy[] = [
  ...
  },
  {
    ...
    metaDescription:
      "The best internship programme in Sri Lanka. Start as an intern at Cypher Digital in Colombo, rotate through multiple departments, and grow to management trainee — guided, flexible, hands-on. No experience needed. Apply via WhatsApp.",
    icon: GraduationCap,
    type: "Paid Internship · Intern → Management Trainee",
    employmentType: ["INTERN", "FULL_TIME"],
    location: "Colombo, Sri Lanka",
    summary:
      "The best internship programme in Sri Lanka isn't one that leaves you making coffee. Start as an intern, rotate through multiple real departments — social, ads, design, content, video and client servicing — and get guided, step by step, all the way to management trainee.",
    salaryRange: { min: 20000, max: 40000, currency: "LKR", unit: "MONTH" },
    kwIntro:
      "Searching for an internship in Sri Lanka, an internship programme in Colombo, or an agency internship where you'll actually learn something? Cypher Digital's Internship Programme rotates you across multiple departments, guides you with a dedicated mentor, and grows you from intern to management trainee. No experience needed — we train you from scratch on live client campaigns for 800+ Sri Lankan brands.",
    seoIntro: [
      "If you're searching for an internship in Sri Lanka, an internship programme in Colombo, or an agency internship where you'll actually learn something — this is built for you.",
      "Most internships in Sri Lanka park you in one corner doing one repetitive task. Ours does the opposite. This is a structured internship programme that moves you through multiple departments, guides you with a real mentor, and is designed to grow you from intern to management trainee — so you leave with genuine, broad experience and a career, not just a line on your CV.",
      "You don't need experience or a finished degree. You need drive and the willingness to learn. We handle the training.",
    ],
    softwareSkills: {
      intro: "This is what makes it the most challenging and rewarding internship in Sri Lanka: you don't do one thing for six months. You rotate through the real sections of a working agency and learn how each one operates on live client campaigns.",
      items: [
        { icon: "📱", name: "Social Media", desc: "Content planning, scheduling and page management across Facebook, Instagram and TikTok." },
        { icon: "💰", name: "Paid Ads", desc: "Meta Ads and Google Ads campaign support and reporting on live client budgets." },
        { icon: "✍️", name: "Content & Copy", desc: "Captions, briefs and campaign messaging that get results." },
        { icon: "🎨", name: "Graphic Design", desc: "Visuals for social, ads and brand work using Canva and the Adobe suite." },
        { icon: "🎬", name: "Video", desc: "Editing and short-form content for real Sri Lankan brands." },
        { icon: "🔍", name: "SEO", desc: "On-page and content optimisation basics that move rankings." },
        { icon: "🤝", name: "Client Servicing", desc: "How agencies manage, retain and grow client relationships." },
      ],
    },
    portfolioSteps: {
      intro: "You are never left to figure it out alone. Every stage of the internship programme has structure and a mentor.",
      steps: [
        "Stage 1 — Intern. Learn the fundamentals by doing, across departments. A team lead mentors you and reviews your work every week. You shadow, then you do.",
        "Stage 2 — Management Trainee. Once you've proven you can be trusted with real work, you step up. Own client work end-to-end and start managing pieces of accounts.",
        "Stage 3 — Executive. Own accounts and outcomes, lead campaigns and start mentoring the next batch of interns.",
    ...
    dayInLife: {
      intro: "A schedule built around university timetables, a learning path that flexes to your strengths, and hybrid flexibility on some projects. Here's what a typical day inside the programme looks like.",
      items: [
        { time: "9:00 AM", task: "Daily stand-up with your rotation team. Review yesterday's work and what's shipping today." },
        { time: "9:30 AM", task: "Rotation task — could be scheduling social content, pulling ad reports, or drafting captions for a client." },
        { time: "11:00 AM", task: "Sit in on a live client call or a strategy session with your mentor and take structured notes." },
        { time: "12:30 PM", task: "Lunch with the team — mostly interns, trainees and execs debating what's actually converting this week." },
        { time: "1:30 PM", task: "Cross-department work — design a story slide, edit a Reel in CapCut, or draft an SEO brief." },
        { time: "3:30 PM", task: "Weekly mentor review. Your team lead walks through your work, feedback and the next skill to unlock." },
        { time: "5:00 PM", task: "Log what you shipped, what you learnt, and what you'd try differently tomorrow." },
      ],
    },
    duties: [
      "Start on real client work in your first weeks — no coffee runs",
      "Rotate through multiple departments to learn the whole agency",
      "Support live Meta Ads, Google Ads, social, design and video work for 800+ brands",
    ...
    requirements: [
      ...
      "Curious about social media, ads, design or content",
    ],
    perks: [
      "The intern-to-management-trainee pathway — a real career, not a dead-end internship",
      "Broad, hands-on experience across multiple departments",
      "One-on-one mentorship from senior marketers and designers",
    ...
    whyJoin: [
      { title: "You rotate through multiple departments", body: "Most internships trap you in one task. Here you train across social, ads, design, content, video and client servicing — real, challenging, broad experience." },
      ...
      { title: "Built to grow you, not use you", body: "A clear intern → management trainee → manager pathway. You start with nothing and leave with a career and real work for 800+ Sri Lankan brands on your CV." },
    ],
    faqs: [
      { q: "What makes this the best internship programme in Sri Lanka?", a: "Instead of one repetitive task, you rotate through multiple departments — social media, paid ads, design, content, video and client servicing — with a dedicated mentor guiding you, and a clear pathway from intern to management trainee. It's broader, more challenging, and built to grow you into a career." },
      ...
      { q: "Will I really work across multiple departments?", a: "Yes. Rotating across sections is the core of the programme. You'll get hands-on exposure to social, ads, design, content, video, SEO and client servicing, so you understand the whole agency — which is what prepares you for management trainee level." },
