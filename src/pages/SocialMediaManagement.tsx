        ...
        <div className="container mx-auto px-4 max-w-5xl">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {[
              ...
              { label: "Facebook Ads Cost", path: "/facebook-ads-cost-sri-lanka", desc: "A clear split between Meta ad spend, management and creative costs, with practical budget controls." },
              { label: "Facebook Retargeting", path: "/facebook-retargeting-sri-lanka", desc: "Follow-up campaigns for website visitors, page engagers, video viewers and warm leads." },
              { label: "Facebook Page Management", path: "/facebook-page-management-sri-lanka", desc: "Page setup, content calendars, publishing, inbox handling, reviews and reporting." },
              { label: "Facebook Ad Creative", path: "/facebook-ad-design-sri-lanka", desc: "Feed, Story, Reel and carousel creative designed around a clear campaign offer." },
