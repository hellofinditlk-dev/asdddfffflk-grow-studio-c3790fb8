...
const BlogPost114 = () => (
  <>
    <SEOHead
      ...
      canonical="https://cypherdigital.lk/blog/b2b-leads-linkedin-sri-lanka"
    />
      ...
      <div className="container mx-auto px-4">
        <div className="max-w-2xl mx-auto">
          <header className="mb-10">
            ...
            <h1 className="font-heading text-2xl md:text-3xl font-extrabold mt-3 mb-4">How to Get B2B Leads on LinkedIn in Sri Lanka</h1>
          </header>
          <div className="prose prose-sm max-w-none text-muted-foreground leading-relaxed space-y-5 [&>h2]:text-foreground [&>h2]:font-heading [&>h2]:text-xl [&>h2]:font-bold [&>h2]:mt-8 [&>h2]:mb-3 [&>h3]:text-foreground [&>h3]:font-semibold [&>h3]:text-lg [&>h3]:mt-6 [&>h3]:mb-2 [&>ul]:list-disc [&>ul]:pl-6 [&>ul]:space-y-1 [&>ol]:list-decimal [&>ol]:pl-6 [&>p>strong]:text-foreground [&_a]:text-primary [&_a:hover]:underline" dangerouslySetInnerHTML={{ __html: `<p><em>If your business sells to other businesses in Sri Lanka, LinkedIn
is your most powerful lead generation tool. With over 1 million Sri
Lankan professionals on the platform, LinkedIn gives you direct access
...
audience</p></li>
<li><p>How-to posts that solve your ideal client’s problems</p></li>
...
value</p></li>
<li><p>Ignoring comments and DMs on posts</p></li>
<li><p>Using the same content as Facebook and Instagram</p></li>
<li><p>Not investing in LinkedIn advertising despite the quality of
leads</p></li>
...
can generate a steady pipeline of qualified business leads month after
month.</p>
` }} />
