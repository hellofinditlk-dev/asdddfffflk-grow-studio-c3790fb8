...
const BlogPost118 = () => (
  <>
    <SEOHead
      ...
      canonical="https://cypherdigital.lk/blog/social-media-marketing-trends-sri-lanka-2026"
    />
      ...
      <div className="container mx-auto px-4">
        <div className="max-w-2xl mx-auto">
          <header className="mb-10">
            ...
            <h1 className="font-heading text-2xl md:text-3xl font-extrabold mt-3 mb-4">Social Media Marketing Trends in Sri Lanka for 2026</h1>
          </header>
          <div className="prose prose-sm max-w-none text-muted-foreground leading-relaxed space-y-5 [&>h2]:text-foreground [&>h2]:font-heading [&>h2]:text-xl [&>h2]:font-bold [&>h2]:mt-8 [&>h2]:mb-3 [&>h3]:text-foreground [&>h3]:font-semibold [&>h3]:text-lg [&>h3]:mt-6 [&>h3]:mb-2 [&>ul]:list-disc [&>ul]:pl-6 [&>ul]:space-y-1 [&>ol]:list-decimal [&>ol]:pl-6 [&>p>strong]:text-foreground [&_a]:text-primary [&_a:hover]:underline" dangerouslySetInnerHTML={{ __html: `<p><em>Social media in Sri Lanka is evolving at a rapid pace. What
worked in 2023 no longer guarantees results in 2026. Platforms are
...
partnering with a specialist agency that lives and breathes these trends
every day.</p>
` }} />
