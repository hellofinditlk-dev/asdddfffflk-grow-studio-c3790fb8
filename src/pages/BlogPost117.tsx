...
const BlogPost117 = () => (
  <>
    <SEOHead
      ...
      canonical="https://cypherdigital.lk/blog/how-to-set-up-google-ads-sri-lanka"
    />
      ...
      <div className="container mx-auto px-4">
        <div className="max-w-2xl mx-auto">
          <header className="mb-10">
            ...
            <h1 className="font-heading text-2xl md:text-3xl font-extrabold mt-3 mb-4">How to Set Up Google Ads for a Sri Lankan Business (2026 Guide)</h1>
          </header>
          <div className="prose prose-sm max-w-none text-muted-foreground leading-relaxed space-y-5 [&>h2]:text-foreground [&>h2]:font-heading [&>h2]:text-xl [&>h2]:font-bold [&>h2]:mt-8 [&>h2]:mb-3 [&>h3]:text-foreground [&>h3]:font-semibold [&>h3]:text-lg [&>h3]:mt-6 [&>h3]:mb-2 [&>ul]:list-disc [&>ul]:pl-6 [&>ul]:space-y-1 [&>ol]:list-decimal [&>ol]:pl-6 [&>p>strong]:text-foreground [&_a]:text-primary [&_a:hover]:underline" dangerouslySetInnerHTML={{ __html: `<p><em>Google Ads is one of the most powerful and measurable forms of
advertising available to Sri Lankan businesses. When set up correctly,
it puts your business at the top of Google search results exactly when
...
with clear purchase intent — for example, ‘digital marketing agency
colombo’ is more valuable than just ‘digital marketing’ because the
first phrase shows the searcher wants to hire someone.</p>
<ul>
<li><p>Include location modifiers: ‘in Sri Lanka’, ‘Colombo’,
‘Kandy’</p></li>
<li><p>Use exact match and phrase match for tighter control</p></li>
<li><p>Add negative keywords to exclude irrelevant searches
(e.g. ‘free’, ‘jobs’)</p></li>
...
<li><p>Sending all traffic to the homepage instead of a dedicated
landing page</p></li>
<li><p>Not adding negative keywords to block irrelevant traffic</p></li>
...
thinking. Many businesses see far better results when they work with a
certified Google Ads specialist who understands the local market.</p>
` }} />
