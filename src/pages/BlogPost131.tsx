...
const VACANCIES = [
  { title: "Marketing Intern", type: "Internship (3–6 months) · Paid", salary: "LKR 25,000 – 45,000", href: "/careers/marketing-internship-sri-lanka", hot: true },
      ...
      <div className="container mx-auto px-4">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="prose prose-neutral max-w-none text-foreground">
            ...
            <p>To maximise your chances of converting to a full-time <Link to="/careers/digital-marketing-jobs-sri-lanka" className="text-primary font-semibold underline">digital marketing executive job in Sri Lanka</Link>, treat every brief as if it were your permanent job. Deliver before deadlines, ask for feedback on every piece of work, and develop a second skill alongside your primary one.</p>
