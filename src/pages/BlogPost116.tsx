...
const BlogPost116 = () => (
  <>
    <SEOHead
      ...
      canonical="https://cypherdigital.lk/blog/google-ads-vs-facebook-ads-sri-lanka"
    />
      ...
      <div className="container mx-auto px-4">
        <div className="max-w-2xl mx-auto">
          <header className="mb-10">
            ...
            <h1 className="font-heading text-2xl md:text-3xl font-extrabold mt-3 mb-4">Google Ads vs Facebook Ads in Sri Lanka: Which Converts Better?</h1>
          </header>
          <div className="prose prose-sm max-w-none text-muted-foreground leading-relaxed space-y-5 [&>h2]:text-foreground [&>h2]:font-heading [&>h2]:text-xl [&>h2]:font-bold [&>h2]:mt-8 [&>h2]:mb-3 [&>h3]:text-foreground [&>h3]:font-semibold [&>h3]:text-lg [&>h3]:mt-6 [&>h3]:mb-2 [&>ul]:list-disc [&>ul]:pl-6 [&>ul]:space-y-1 [&>ol]:list-decimal [&>ol]:pl-6 [&>p>strong]:text-foreground [&_a]:text-primary [&_a:hover]:underline" dangerouslySetInnerHTML={{ __html: `<p><em>Google Ads or Facebook Ads — this is the debate every Sri Lankan
business owner faces when starting digital advertising. Both platforms
...
<li><p>Your target customer is looking for solutions to a specific
problem</p></li>
...
demographic</p></li>
<li><p>You are running a sale, event, or time-sensitive
promotion</p></li>
...
delivers the strongest results.</p>
` }} />
