  ...
  <footer className="border-t border-border bg-secondary" role="contentinfo">
    <div className="container mx-auto px-4 py-16">
      <div className="grid md:grid-cols-3 lg:grid-cols-6 gap-10">
        ...
        <div>
          ...
          <div className="flex flex-col gap-2.5 text-sm text-muted-foreground">
            ...
            <Link to="/ai-video-production-sri-lanka" className="hover:text-foreground transition-colors">AI Video Production</Link>
            <Link to="/reel-creation-sri-lanka" className="hover:text-foreground transition-colors">Reel Creation</Link>
            ...
            <Link to="/linkedin-marketing-sri-lanka" className="hover:text-foreground transition-colors">LinkedIn Marketing</Link>
            <Link to="/instagram-marketing-sri-lanka" className="hover:text-foreground transition-colors">Instagram Marketing</Link>
            ...
            <Link to="/tv-advertising-sri-lanka" className="hover:text-foreground transition-colors">TV Advertising</Link>
            <Link to="/newspaper-advertising-sri-lanka" className="hover:text-foreground transition-colors">Newspaper Advertising</Link>
            <Link to="/radio-advertising-sri-lanka" className="hover:text-foreground transition-colors">Radio Advertising</Link>
            <Link to="/programmatic-advertising-sri-lanka" className="hover:text-foreground transition-colors">Programmatic Advertising</Link>
            <Link to="/call-center-outsourcing-sri-lanka" className="hover:text-foreground transition-colors">Call Center Outsourcing</Link>
            <Link to="/our-work" className="hover:text-foreground transition-colors">Our Work / Portfolio</Link>
          </div>
        </div>
      ...
      <div className="border-t border-border mt-12 pt-6 text-center text-xs text-muted-foreground space-y-2">
        ...
        <p>© 2026 Cypher Digital — <Link to="/" className="hover:text-foreground transition-colors">Digital Marketing Agency Sri Lanka</Link></p>
      </div>
    </div>
  </footer>
);
